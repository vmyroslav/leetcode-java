...
public class Solution {
    private static final int bill = 1000000000;
    ...
    public String numberToWords(int num) {
        ...
        int million = (num - billion * bill) / mill;
        int thousand = (num - billion * bill - million * mill) / 1000;
        int rest = num - billion * bill - million * mill - thousand * 1000;
